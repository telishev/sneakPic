...
void merge_path_operation::apply (svg_item_path *path_dest, svg_path_geom_iterator dest, svg_item_path *path_src, svg_path_geom_iterator src)
{
...
void merge_path_operation::merge_inside (svg_item_path *path, svg_path_geom_iterator dest, svg_path_geom_iterator src)
{
  ...
  svg_path_geom *dest_path = path_edit->path ();
...
void merge_path_operation::merge_paths (svg_item_path *item_path_dest, svg_path_geom_iterator dest,
                                        svg_item_path *item_path_src, svg_path_geom_iterator src)
{
  ...
  svg_path_geom *dest_path = path_dest_edit->path ();
  const svg_path_geom *src_path = path_src_edit->path ();
  /// TOOO: make it better
