...
{
  typedef std::pair<svg_item_path *, svg_path_iterator> snap_point_t;
...
private:
  ...
  svg_item_path *merge_with_path (svg_item_path *path_dst, svg_path_iterator dst_it, svg_item_path *path_src, svg_path_iterator src_it);
};
