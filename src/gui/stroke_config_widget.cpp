...
{
  {
    ...
    m_view->add_widget ((int)style_controller_role_t::LINEJOIN, m_stroke_linejoin_combobox);
  }
}
...
{
  {
    ...
    m_view->add_widget ((int)style_controller_role_t::STROKE_MITER, m_stroke_miterlimit_spinbox);
    layout->addStretch ();
  }
}
...
{
  {
    ...
    m_view->add_widget ((int)style_controller_role_t::STROKE_WIDTH, m_stroke_width_spinbox);
    layout->addStretch ();
  }
}
...
{
  {
    ...
    m_view->add_widget ((int)style_controller_role_t::LINECAP, m_stroke_linecap_combobox);
  }
}
