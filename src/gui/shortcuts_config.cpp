...
void shortcuts_config::fill_mouse_default ()
{
  ...
  set_mouse_shortcut (m::SELECT_ITEM                 , e::CLICK      , b::BUTTON_LEFT , k::ALL               );
  ...
  set_mouse_shortcut (m::ADD_PATH_POINT              , e::DOUBLECLICK, b::BUTTON_LEFT , k::ALL               );
  ...
  set_mouse_shortcut (m::ADD_GRADIENT_STOP           , e::DOUBLECLICK, b::BUTTON_LEFT , k::ALL               );
  set_mouse_shortcut (m::SELECT_PREV_ITEM            , e::CLICK      , b::BUTTON_LEFT , k::ALT | k::SHIFT_ALT);
  set_mouse_shortcut (m::SWITCH_SELECTOR_HANDLES_TYPE, e::CLICK      , b::BUTTON_LEFT , k::ALL               );
...
void shortcuts_config::fill_drag_default ()
{
  ...
  set_mouse_drag_shortcut (m::PENCIL               , b::BUTTON_LEFT  , k::ALL                      );
